...
public class TubeVideosManager implements TubeVideosManagerInt {
	...
	public ArrayList<Video> getAllVideosInDB() {
		ArrayList<Video> value = new ArrayList<Video>(this.videoDatabase);
		return value;
	}
	...
	public Video findVideo(String title) {
		...
		for (Video vid : this.videoDatabase) {
	...
	public boolean addVideoToPlaylist(String title, String playlistName) {
		if (title == null || playlistName == null) {
			return false;
		}
		if (findPlayListInternal(playlistName) == null) {
			return false;
	...
	public Playlist searchForVideos(String playlistName, String title, int maximumDurationInMinutes, Genre genre) {
		...
		for (Video vid : videoDatabase) {
			if (title == null || title.equals(vid.getTitle()) && maximumDurationInMinutes < 0
					|| vid.getDurationInMinutes() <= maximumDurationInMinutes && genre == null
					|| genre.equals(vid.getGenre())) {
