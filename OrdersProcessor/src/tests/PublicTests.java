...
public class PublicTests extends TestCase {
	...
	/**
	 * Executes a run of the OrdersProcessor program by reading the data in the
	 * specified file using input redirection. The file inputFileName has the item's
	 * data file, whether multiple threads will be used, number of orders, base file
	 * name for the orders, and the result file name.
	 * 
	 * @param inputFilename
	 * @throws Exception
	 * @throws Throwable
